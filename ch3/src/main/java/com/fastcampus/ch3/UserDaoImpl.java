...
// @Component - @Controller, @Service, @Repository, @ControllerAdvice
@Repository
...
//            try { if(conn!=null)  conn.close();  } catch (SQLException e) { e.printStackTrace();}
    ...
    public User selectUser(String id)  {
        ...
        try {
            ...
            // close()를 호출하다가 예외가 발생할 수 있으므로, try-catch로 감싸야함.
            // close()의 호출순서는 생성된 순서의 역순 !! (rs -> pstmt -> conn)
...
//        PreparedStatement pstmt = null;
        ...
        // try()-with-resources - since jdk7 -> 자원 자동 close (Autoclosable 객체들만 가능)
        try (
